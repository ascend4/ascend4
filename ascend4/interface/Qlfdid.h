...
#ifndef Qlfdid_module_loaded
#define Qlfdid_module_loaded
...
extern char *Asc_MakeInitString(int);
/*
...
extern void Asc_ReInitString(char *);
/*
 *  Asc_ReInitString;
 *  char *str;
...
extern struct SearchEntry *Asc_SearchEntryCreate(char *,struct Instance *);
/*
...
extern struct Instance *Asc_SearchEntryInstance(struct SearchEntry *);
/*
 *  Asc_SearchEntryInstance(se);
 *  struct SearchEntry *se;
 *  Comments : Returns a the instance pointer from a search entry;
 */

extern char *Asc_SearchEntryName(struct SearchEntry *);
/*
 *  Asc_SearchEntryName(se)
 *  struct SearchEntry *se;
 *  Comments : Returns the name of a search entry;
 */
...
extern struct gl_list_t *Asc_BrowQlfdidSearch(char *, char *);
/*
...
extern int Asc_QlfdidSearch2(char *);
/*
...
extern int Asc_QlfdidSearch3(CONST char *, int);
/*
