 ...
 *                      pairs ?
 * REL_COMP_TERM        Does this relation contain only one complementarity
 *                      pair ?
...
#define rel_comp_term(r)	((r)->flags & REL_COMP_TERM)
#else
...
#define rel_set_comp_term(r,bv)     rel_set_flagbit((r),REL_COMP_TERM,(bv))
