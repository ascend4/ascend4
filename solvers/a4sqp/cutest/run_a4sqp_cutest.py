...
def write_tsv_results(results: list[dict[str, object]], args: argparse.Namespace) -> None:
    ...
    fields = [
        ...
        "reduced_gradient_polish_mode",
        "reduced_gradient_polish_attempts",
        "reduced_gradient_polish_accepts",
        "solve_time",
        "setup_time",
        "driver_error",
        "log",
            ...
            writer.writerow(
                {
                    ...
                    "reduced_gradient_polish_mode": result.get("reduced_gradient_polish_mode", ""),
                    "reduced_gradient_polish_attempts": result.get("reduced_gradient_polish_attempts", ""),
                    "reduced_gradient_polish_accepts": result.get("reduced_gradient_polish_accepts", ""),
