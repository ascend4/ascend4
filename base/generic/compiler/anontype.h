 ...
 *  Special cases:
 *
 *  1. Relations, logical relations, and when statements are always
 ...
 *     algorithm.
 *
 *  2. Arrays. ASCEND arrays just suck. The approach here is
 *     conservative; there may be fewer array cliques than we can
 *     compute with a single pass algorithm.
 *
 *  3. Undefined constants. Constant reals/integers which are undefined
 ...
 * <!--  struct Instance *i;                                           -->
 * <!--  struct AnonType *at;  at = Asc_GetAnonType(atl,n);            -->
