 ...
 *  There is not a corresponding compiler.c. The variables
 *  declared in this header are defined in ascParse.y.<br><br>
 *
 *  This header and tcl/tk headers are known to conflict. This header
 *  should be included AFTER tcl.h or tk.h, not before.
 *  <pre>
 *  When #including compiler.h, make sure these files are #included first:
