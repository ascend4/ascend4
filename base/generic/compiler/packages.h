...
/**< 
	@param name the short name of the library. (include 'lib' prefix?)
	@return 0 if success, 1 if failure.

	@deprecated 
	This is a rather pointless wrapper to the ascDynaLoad functions. @see ascDynaLoad.h for correct replacement.
