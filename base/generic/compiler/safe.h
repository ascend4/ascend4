...
extern double safe_log10_D0(double x, enum safe_err *safe);
...
extern double safe_log10_D1(double x, enum safe_err *safe);
...
extern double safe_log10_D2(double x, enum safe_err *safe);
...
extern double safe_log10_Dn(double x, int n, enum safe_err *safe);
