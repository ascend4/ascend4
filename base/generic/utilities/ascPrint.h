 ...
 *  If the vtable's name conflicts, return 1 otherwise return 0.<br><br>
 *
 ...
 *  number of bytes printed from the final vtable that is called.<br><br>
 *
 ...
 *  return 0 for success and EOF for failure.<br><br>
 *
 ...
 *  file pointer `fileptr'; return 1 for success and EOF for failure.<br><br>
 *
 *  This is needed under Windows to redirect stdout and stderr to the
 *  TkConsole instead of into the bit bucket.
 */
