 ...
 * Use STDHLF_H(yourCmd); in your header file to define your function.
 *
...
/*
 * here's a macro to make the header for your function made with HLF.
 */
#define STDHLF_H(baseName) extern char *baseName##HLF(void)

extern char *HelpBuildString(char *, ...);
/*
 ...
 * The string returned is the callers responsibility.
 * Up to the first MAXHELPARGS are used in the returned string.
 */

extern int Asc_HelpCheck(ClientData, Tcl_Interp *, int, CONST84 char **);
...
extern int Asc_HelpDefineGroup(CONST char *, CONST char *);
/*
...
extern int Asc_HelpDefine(CONST char *, CONST char *, CONST char *,
                          CONST char *, HLFunc);
/*
 *  Asc_HelpDefine(name,group,usage,short,longfunc)
 *  CONST char *name, *group, *usage, *short;
 *  char * HLFunc(void);
 ...
 *
 *  name is the tcl registration string.
 *  group is the command group name.
 *  The string given for group should not contain whitespace.
 *  usage is the command syntax by example or in man page style.
 *  short is the basic one-line description of the command. (<= 70 char)
 *  long is the detailed explanation of the command.
 *  All 5 of these strings should be coming via defines in the
 *  C header files for the function being documented.
 *  See Asc_HelpCmd below for an example of same.
 *
...
extern CONST char *Asc_HelpGetShort(Tcl_Interp *, CONST84 char *);
/*
...
extern CONST char *Asc_HelpGetLong(Tcl_Interp *, CONST84 char *);
/*
...
extern CONST char *Asc_HelpGetUsage(Tcl_Interp *, CONST84 char *);
/*
...
extern int Asc_HelpGetGroup(Tcl_Interp *, CONST84 char *);
/*
...
extern int Asc_HelpCommandGroups(Tcl_Interp *);
/*
...
extern int Asc_HelpCommandList(Tcl_Interp *);
/*
...
extern int Asc_HelpCommandsByGroups(Tcl_Interp *);
/*
...
/*
 * source of our long help string.
 */

extern int Asc_HelpCmd(ClientData, Tcl_Interp *, int, CONST84 char **);
/*
