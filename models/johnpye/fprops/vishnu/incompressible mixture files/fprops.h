...
double fprops_rho(FluidState state, FpropsError *err); ///< density / kg/m3 // added for incompressible
...
double fprops_psat(FluidState state, FpropsError *err); 
double fprops_Tfreeze(FluidState state, FpropsError *err); 
