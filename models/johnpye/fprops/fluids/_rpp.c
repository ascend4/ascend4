...
static const CubicData cubic_data_water = {
	.M = 18.015
	,.T_c = 647.3 //kelvin
	,.p_c = (221.2 * 1e5) //pascal
	,.rho_c = (1000 * 18.015 / 57.1)
	,.T_t = 273.16 //http://www.cheric.org/kdb/kdb/hcprop/showprop.php?cmpid=1914
	,.omega = 0.344
	,.ref = {FPROPS_REF_IIR}
...
static const CubicData cubic_data_carbon_dioxide = {
	...
	,.T_t = 216.58 //http://www.cheric.org/kdb/kdb/hcprop/showprop.php?cmpid=1943
	,.omega = 0.239
	,.ref = {FPROPS_REF_IIR}
