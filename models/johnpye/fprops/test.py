...
s = '%s %s color.c refstate.c ideal.c cp0.c helmholtz.c pengrob.c sat.c fprops.c zeroin.c test.c fluids/%s.c -Wall -DTEST -o fluids/test-%s %s' % (CC,CFLAGS,species,species,gslflags)
