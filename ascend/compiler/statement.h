...
*/
extern struct Statement *CreateSUBSOLVER(CONST char *solvername);
/**<
	Create a 'SUBSOLVER' statement node.
*/
extern struct Statement *CreateINTEGRATOR(CONST char *solvername);
/**<
	Create a 'INTEGRATOR' statement node.
*/
extern struct Statement *CreateINTEGRATE(CONST char *solvername,struct Expr *fromExp,struct Expr *toExp,struct Expr *stepsExp);
/**<
	Create a 'INTEGRATE' statement node.
*/
