...
#define context_EVENT    0x800 /**< statement is in EVENT's statement list
                                    Not sure if I will need it, so let it be
                                    until I see if this is necessary (Ksenija) */
...
struct EventList {
  struct EventList *next;       /**< next in list */
  struct Set *values;           /**< matching values of the case */
  struct StatementList *slist;  /**< statements to be executed */
};
...
struct StateEVENT {
  struct Name *nptr;          /**< Name of the EVENT */
  struct VariableList *cond;  /**< list of variables */
  struct EventList *el;        /**< list of cases  */
};
...
struct StateIS {
  ...
  int isatype;              /**< Type of IS_A: ordinary IS_A statement - 0,
                                 IS_A generated by DERIVATIVE OF - 1,
                                 IS_A generated by PREVIOUS - 2 */
...
#define contains_EVENT 0x100000 /**< true if EVENT in statements lists */
#define contains_ISPRE 0x200000 /**< true if PREVIOUS in statements lists */
#define contains_ILL 0x400000   /**< true if illegal statement in loop */
