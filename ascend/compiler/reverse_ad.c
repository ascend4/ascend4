	...
	while(tracer!=NULL){
		switch(tracer->expr_type){
			...
			case e_times:
				...
				tracer->arg1->bar.val = safe_temp1;
				tracer->arg2->bar.val = safe_temp2;
				break;
			case e_divide:
				combibar = tracer->bar.val;
				arg1val = tracer->arg1->val.val;
...
#define fxn (y->fxnptr)
	while(tracer!=NULL){
		switch(tracer->expr_type){
			...
			case e_minus:
				a1bd = ybd;
				a2bd = -ybd; // safe_sub_D0(0,ybd,serr) ?
				break;
			case e_times:
				a1bd = safe_add_D0(safe_mul_D0(ybd,a2v,serr),safe_mul_D0(yb,a2d,serr),serr);
				a2bd = safe_add_D0(safe_mul_D0(ybd,a1v,serr),safe_mul_D0(yb,a1d,serr),serr);
				break;
			case e_divide:
				...
				a1bd = safe_add_D0(safe_mul_D0((ybd),(deriv1),serr),safe_mul_D0((yb),safe_mul_D0(deriv1_2_2nd,(a2d),serr),serr),serr);
				a2bd = safe_add_D0(safe_mul_D0(ybd,deriv2,serr),safe_add_D0(safe_mul_D0(yb,safe_mul_D0(deriv1_2_2nd,a1d,serr),serr),safe_mul_D0(deriv2_2nd,a2d,serr),serr),serr);
				break;
			case e_uminus:
				a1bd = -ybd;  // safe_sub_D0(0,ybd,serr) ?
				break;
			case e_power:
				...
				deriv1_2_2nd = safe_add_D0(safe_pow_D0(a1v,a2v-1,serr),safe_mul_D0(a2v,safe_mul_D0(safe_pow_D0(a1v,a2v-1,serr),safe_ln_D0(a1v,serr),serr),serr),serr);
				a1bd = safe_add_D0(safe_mul_D0(ybd,deriv1,serr),safe_mul_D0(yb,safe_add_D0(safe_mul_D0(deriv1_2nd,a1d,serr),safe_mul_D0(deriv1_2_2nd,a2d,serr),serr),serr),serr);
				a2bd = safe_add_D0(safe_mul_D0(ybd,deriv2,serr),safe_mul_D0(yb,safe_add_D0(safe_mul_D0(deriv1_2_2nd,a1d,serr),safe_mul_D0(deriv2_2nd,a2d,serr),serr),serr),serr);
				break;
			case e_ipower:
				deriv1 = safe_mul_D0(ia2v,safe_ipow_D0(a1v,ia2v-1,serr),serr);
				deriv2 = safe_mul_D0(safe_ipow_D0(a1v,ia2v,serr),safe_ln_D0(a1v,serr),serr);
				deriv1_2nd = safe_mul_D0(safe_mul_D0(ia2v,ia2v-1,serr),safe_ipow_D0(a1v,ia2v-2,serr),serr); 
				deriv2_2nd = safe_mul_D0(safe_ipow_D0(a1v,ia2v,serr),safe_pow_D0(safe_ln_D0(a1v,serr),2,serr),serr);
				deriv1_2_2nd = safe_add_D0(safe_ipow_D0(a1v,ia2v-1,serr),safe_mul_D0(ia2v,safe_mul_D0(safe_ipow_D0(a1v,ia2v-1,serr),safe_ln_D0(a1v,serr),serr),serr),serr);
				a1bd = safe_add_D0(safe_mul_D0(ybd,deriv1,serr),safe_mul_D0(yb,safe_mul_D0(deriv1_2nd,a1d,serr),serr),serr);
				a2bd = safe_mul_D0(ybd,deriv2,serr) ;
				break;
			case e_func:
