...
*/
  ...
  e_uminus	= 9,  /**< unary minus */
  e_func	= 10,    /**< unary real function */

  e_plus	= 11,    /**< addition, set union */
  e_minus	= 12,    /**< subtraction, set difference */
  e_times	= 13,    /**< multiplication, set intersection */
  e_divide	= 14,  /**< division */
  e_power	= 15,    /**< a^x */
  e_ipower	= 16,  /**< a^n */
